...
#nltk.download('punkt')
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql+psycopg2://joyeuse:Og3nR3MnJH2AmAKOuyaKswWaETmq3bm7@dpg-cf37gs9gp3jl0q3eugdg-a.oregon-postgres.render.com/chatdb_knbo"
db = SQLAlchemy(app)
CORS(app)
## Database
